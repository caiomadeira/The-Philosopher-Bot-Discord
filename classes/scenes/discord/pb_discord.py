...
import textwrap
import os
from resources.localizable.img_list import PHILOSOPHERS_LIST
from resources.assets.templates.New_Img_Manipulation.path_reference import template_folder_reference
...
async def philobot(ctx, *, mensagem):
    try:
        img = Image.open(f'{template_folder_reference}/background_image.png')
